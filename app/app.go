...
func New(
	...
	app.DotcelKeeper = *dotcelmodulekeeper.NewKeeper(
		appCodec,
		keys[dotcelmoduletypes.StoreKey],
		keys[dotcelmoduletypes.MemStoreKey],
		app.GetSubspace(dotcelmoduletypes.ModuleName),
	)
